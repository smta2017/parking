  ...
  <div class="{{ $crud->getListContentClass() }}">
    ...
    <div class="card">
      <div class="card-header">
        <h4 class="card-title text-capitalize">{!! $crud->getHeading() ?? $crud->entity_name_plural !!}
      ...
      <div class="card-content collapse show">
        <div class="card-body card-dashboard">
          ...
          <table id="crudTable" class="table table-striped table-bordered zero-configuration" 
          >
            <thead>
              <tr>
                {{-- Table columns --}}
