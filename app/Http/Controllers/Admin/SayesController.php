...
class SayesController extends Controller
{
    /**
    ...
    public function create()
    {
         ...
         $customers = User::sayesZone()->orderBy('created_at')->get();
        return \view('pages.sayes-create',compact('customers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $request['zone_id'] = session('session_zone_id');
